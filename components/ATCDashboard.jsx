...
// === MOCK DATA (would be seeded from ATC's actual spreadsheets) ===
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 24 }}>
              ...
              <div style={{ background: COLORS.card, border: `1px solid ${COLORS.border}`, borderRadius: 10, padding: 20 }}>
                ...
                <div style={{ display: "flex", gap: 16, justifyContent: "center", marginTop: 8 }}>
                  {[["KSA", COLORS.accent], ["USA", COLORS.blue], ["UK", COLORS.teal], ["Poland", COLORS.coral]].map(([l, c]) => (
                    <div key={l} style={{ display: "flex", alignItems: "center", gap: 4, fontSize: 11, color: COLORS.textDim }}>
              ...
              <div style={{ background: COLORS.card, border: `1px solid ${COLORS.border}`, borderRadius: 10, padding: 20 }}>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 8, justifyContent: "center", marginTop: 8 }}>
                  {serviceBreakdown.map((s, i) => (
                    <div key={s.name} style={{ display: "flex", alignItems: "center", gap: 4, fontSize: 10, color: COLORS.textDim }}>
                      <div style={{ width: 8, height: 8, borderRadius: 2, background: PIE_COLORS[i] }} />{s.name}
                    </div>
                  ))}
                </div>
              </div>
